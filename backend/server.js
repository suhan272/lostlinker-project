// server.js - Production-ready version with environment variables
...
app.use((req, res, next) => {
    // Allow requests from VS Code Live Server and localhost
    const allowedOrigins = [
        'http://127.0.0.1:5509',  // VS Code Live Server
        'http://localhost:5509',  // Alternative VS Code Live Server
        'http://localhost:3000',  // Direct access
        'http://127.0.0.1:3000'   // Direct access alternative
    ];
